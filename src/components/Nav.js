    ...
    return (
        ...
        <nav className=" container-fluid bg-black px-5">
            <div className="navbar navbar-expand-lg navbar-dark d-flex justify-content-between">
                ...
                <Link to="/" className="">
                    <img src={process.env.PUBLIC_URL + "./assert/trav.png"} className="d-block mx-lg-auto img-fluid" alt="Bootstrap Themes" width="65px" height="65px" loading="lazy" />
                </Link>
                <div className="d-flex justify-content-center">
                    <Link to="/" className="btn " style={{ color: "white" }} >Home</Link>
                    <Link to="/posts" className="btn " style={{ color: "white" }} >Posts</Link>
